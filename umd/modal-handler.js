...
(function (global, factory) {
    ...
    (global = global || self, global.MODAL = factory(global.jQuery, global.c2EventHandler));
    ...
    var Modal = function Modal($el, id, options) {
      ...
      if (this.opts.overlayHTML) {
        // create overlay
        this.$overlay = $(this.opts.overlayHTML); // append the modal and overlay to the body
